...
import WsClientTest from '../../../src/clients/WsClientTest';

test.describe.only('API auth + ws', () => {
    let apiClient;
    let wsClient;

    test.beforeEach(async ({ request }) => {
        apiClient = new ApiClient(request);
        wsClient = new WsClientTest('wss://stage-backend-api-gateway-c1g0.creagen.app/ws');
    });
